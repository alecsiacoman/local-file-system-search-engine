...
echo Starting Worker 3 on port 3903...
start cmd /k mvn spring-boot:run -DskipTests=true -Dspring-boot.run.main-class=bruteforce.worker.WorkerApplication -Dspring-boot.run.arguments="--server.port=3903 --worker.directory=C:\Users\coman\Desktop\search-engine-test\dir3"
